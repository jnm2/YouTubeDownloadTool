...
namespace YouTubeDownloadTool
{
    public sealed class MainViewModel : ViewModel
    {
        ...
        private ToolResolver youTubeDLResolver;
        private ToolResolver ffmpegResolver;

        private string downloadUrls = string.Empty;
        public string DownloadUrls { get => downloadUrls; set => Set(ref downloadUrls, value); }

        public MainViewModel(string toolCachePath)
        {
        ...
        public async Task TestAsync(Action<string> showErrorMessage)
        {
